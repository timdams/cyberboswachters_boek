...
## De problemen van wifi (vervolg)

![Een oud voorbeeld van hoe wifi signalen "uit" een gebouw veel verder geraken dan verwacht (bron van de afbeelding: onbekend)](wifi_assets/afstand.jpg){ width=75% }
...
![Wargames: een cultklassieker uit 1983.](wifi_assets/wargames.png){ width=30% }
...
![Een rogue access point is de ideale manier om binnen te geraken voor hackers.](wifi_assets/rogue.png){ width=70% }

![Het kan iedereen overkomen...](wifi_assets/backmaga.png){ width=70% }
...
## Onbeveiligde managementframes (vervolg)
...
![Eve gebruikt spoofing om de wifi-sessie van Alice ongemerkt over te nemen.](wifi_assets/spoofwifi.png){ width=80% }
...
![Een fake access point opzetten met dank aan de onbeveiligde managementframes.](wifi_assets/mitmwifi.png){ width=70% }
...
## De 802.11 standaard qua beveiliging (vervolg)
...
## Open-system authentication (vervolg)
...
![De shared-key authentication aan de start van de verbinding.](wifi_assets/sharedkey.png)

---

## Shared-key authentication (vervolg)
...
![De 802.11 stack (rechts) ten opzichte van de OSI stack.](wifi_assets/osimac.png){ width=75% }

---

## Hoe werkt WEP?

![Een vereenvoudigde voorstelling van WEP in z'n geheel.](wifi_assets/wepencr.png)
...
## Hoe werkt WEP? (vervolg)

![Integrity check.](wifi_assets/crc.png)
...
![WEP frame lay-out.](wifi_assets/wepframe.png){ width=80% }
...
## Sleutellengte en de IV (vervolg)
...
## RC4 heeft geen random access mogelijkheden (vervolg)
...
## RC4 staat geen sleutelhergebruik toe (vervolg)
...
## De IV veroorzaakt weak keys (vervolg)
...
## IV collisions treden op (vervolg)
...
![Known plaintext in het wifi-netwerk krijgen.](wifi_assets/inject.png)
...
![Keystreams byte per byte groeien.](wifi_assets/grow.png)
...
![Layer 3 misbruiken door corrupte, geblitflipte pakketjes, een gekende foutboodschap te laten genereren.](wifi_assets/respat.png)
...
## Probleem 4: Sleutelmanagement (vervolg)
...
![Port-based authenticatie met 802.1X.](wifi_assets/port.png){width=80%}
...
![De modulariteit van het 802.1X framework.](wifi_assets/8021x.png){ width=50% }
...
![Het authenticatie-proces op een wifi-netwerk met 802.1X (Enterprise-mode).](wifi_assets/8021X2.png){ width=75% }
...
![Het aanmaken van een MIC met Michael.](wifi_assets/michael.png){ width=60% }
...
## IV selectie verbetering (vervolg)
...
## Key mixing en re-keying (vervolg)
...
![Het mengen van de verschillende sleutels naar een sleutel die ieder pakketje verandert.](wifi_assets/mixing.png)
...
![WPA1 in volle glorie.](wifi_assets/wpa1.png)
...
![CCMP: confidentiality en integrity in één.](wifi_assets/ccmp.png)
...
## Helaas, aan alles komt een einde (vervolg)
