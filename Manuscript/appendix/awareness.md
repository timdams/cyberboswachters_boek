...
![Awareness posters hoeven geen ellenlange teksten te bevatten. Less is more. ](aware/funnyposter.png){ width=30% }
...
![Vaak wordt een incident response plan als een lineaire sequentie getoond, zonder te visualiseren dat er altijd na de followup informatie moet doorstromen naar de prepare fase. Op die manier leren we uit onze fouten, in de hoop dat deze volgende keer niet meer zullen voorkomen. ](aware/incident.png){ width=85% }
