...
![Ieder wachtwoord mapt naar exact één hash.](auth/rainbow0.png){ width=70% }
...
![Van de hash via de reductiefunctie terug naar een ander wachtwoord.](auth/rainbow1.png){ width=70% }
...
![Voorbeeld van een lijst opeenvolgende wachtwoorden en hun hashes.](auth/rainbow2.png){ width=70% }
...
![Ieder wachtwoord mapt naar exact één hash.](auth/rainbow3.png){ width=70% }
