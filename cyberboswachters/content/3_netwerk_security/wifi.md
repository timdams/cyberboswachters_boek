...
![Een oud voorbeeld van hoe wifi signalen "uit" een gebouw veel verder geraken dan verwacht (bron van de afbeelding: onbekend)](assets/afstand.jpg){ width=75% }
...
![Wargames: een cultklassieker uit 1983.](assets/wargames.png){ width=30% }
...
![Een rogue access point is de ideale manier om binnen te geraken voor hackers.](assets/rogue.png){ width=70% }

![Het kan iedereen overkomen...](assets/backmaga.png){ width=70% }
...
![Eve gebruikt spoofing om de wifi-sessie van Alice ongemerkt over te nemen.](assets/spoofwifi.png){ width=80% }
...
![Een fake access point opzetten met dank aan de onbeveiligde managementframes.](assets/mitmwifi.png){ width=70% }
...
![De shared-key authentication aan de start van de verbinding.](assets/sharedkey.png)
...
![De 802.11 stack (rechts) ten opzichte van de OSI stack.](assets/osimac.png){ width=75% }

#### Hoe werkt WEP?

![Een vereenvoudigde voorstelling van WEP in z'n geheel.](assets/wepencr.png)
...
![Integrity check.](assets/crc.png) 
...
![WEP frame lay-out.](assets/wepframe.png){ width=80% }
...
![WEP encryptie.](assets/wepfull.png) 

![WEP decryptie.](assets/wepdec.png) 
...
![Known plaintext in het wifi-netwerk krijgen.](assets/inject.png)
...
![Keystreams byte per byte groeien.](assets/grow.png)
...
![De bitflip aanval.](assets/bitflip.png)
...
![Layer 3 misbruiken door corrupte, geblitflipte pakketjes, een gekende foutboodschap te laten genereren.](assets/respat.png)
...
![Port-based authenticatie met 802.1X.](assets/port.png){width=80%}
...
![De modulariteit van het 802.1X framework.](assets/8021x.png){ width=50% }
...
![Het authenticatie-proces op een wifi-netwerk met 802.1X (Enterprise-mode).](assets/8021X2.png){ width=75% }
...
![Het aanmaken van een MIC met Michael.](assets/michael.png){ width=60% }
...
![Het mengen van de verschillende sleutels naar een sleutel die ieder pakketje verandert.](assets/mixing.png)
...
![WPA1 in volle glorie.](assets/wpa1.png)
...
![CCMP: confidentiality en integrity in één.](assets/ccmp.png)
