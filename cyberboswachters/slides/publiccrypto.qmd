...
![](crypto_assets/kist_metafoor.png){ width=90% fig-alt="Een openstaande kist die iedereen kan dichtklikken, een kist op slot, en de eigenaar die de kist weer opent." }
