...
**De private sleutel moet altijd geheim blijven!**
:::
...
::: {.callout-tip}
De **publieke sleutel** = een openstaande kist. Iedereen kan er een boodschap in leggen en op slot klikken (*encrypteren*). Enkel de eigenaar heeft de **private sleutel** om de kist te openen (*decrypteren*).
:::

::: {.callout-note .fragment}
Bekende publieke cryptosystemen: **RSA**, DSS en El Gamal.
:::
...
::: {.callout-important .fragment}
**Een digitale hash is een ideaal middel om boodschappen digitaal te ondertekenen.**
:::
...
## Digitale handtekeningen: het proces
...
## Digitale handtekeningen: verificatie

Ontvanger verifieert met publieke sleutel:
...
**Verificatie**: zelfde hash genereren → vergelijken met certificaat na decryptie met **publieke sleutel** van CA
...
::: {.callout-note .fragment}
HTTPS + certificaten werken in tandem: encryptie **én** identiteitsverificatie. Pas sinds ~2017 biedt >50% van websites HTTPS aan.
:::
