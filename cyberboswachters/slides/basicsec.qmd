...
*Hoe zet een aanvaller een eerste voet binnen?* &mdash; *initial access vectors*:
...
::: {.incremental}
* **Drive-by download**: een gecompromitteerde webpagina bezoeken volstaat &mdash; *geen klik nodig*. Misbruik van browser-, plugin- of PDF-kwetsbaarheid
* **Watering hole**: aanvaller infecteert een site die zijn doelwit dagelijks raadpleegt (bv. vak-nieuwssite van een defensieleverancier) &mdash; *gerichte* variant
...
::: {.callout-tip .fragment}
Nauw verwant: **malvertising** &mdash; kwaadaardige advertentiebanners via reguliere ad-netwerken op anders gerespecteerde websites.
