...
## Paswoorden als plaintext (vervolg)
...
![Voorbeeld van een lijst opeenvolgende wachtwoorden en hun hashes.](crypto_assets/rainbow2.png){ width=70% }
...
![Ieder wachtwoord mapt naar exact één hash.](crypto_assets/rainbow3.png){ width=70% }
...
![Het salting proces.](crypto_assets/salting.png){ width=90% }
...
![SCRAM.](crypto_assets/scramflow.png){}
...
![Multifactor authenticatie factoren.](crypto_assets/mfa.png){}

---

## Multifactor authentication (vervolg)
...
## Iets wat je bent: Biometrics (vervolg)
...
## Iets wat je hebt: Hardware (vervolg)
...
## Federation en Single Sign-On (SSO) (vervolg)
...
![Een vereenvoudigd single sign-on proces.](crypto_assets/sso.png){}
...
![Enkele van de vele typische SSO knoppen die je geregeld zal tegenkomen.](crypto_assets/ssoexamples.png){ width=40% }
...
## Een Passkey aanmaken: de registratie (vervolg)
