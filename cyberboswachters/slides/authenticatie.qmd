...
![Van gestolen hash `re3xes` → eindpunt `linux23` vinden → chain herberekenen vanuit `passwd` → wachtwoord `culture` ligt één stap vóór de gestolen hash. Bron: Wikimedia Commons, CC BY-SA 4.0.](crypto_assets/rainbow_search.svg){ width=95% }
...
* Rainbow tables zijn een **efficiënte** manier om grote sets wachtwoorden te kraken
  ...
  * Maar enkel bij dictiory-based wachtwoorden
