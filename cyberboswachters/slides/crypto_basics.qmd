...
## {.ai-beeld background-image="assets/cover_crypto.png" background-size="cover"}
...
## Hoe kraak je deze kluis? {.ai-beeld}

![](assets/crypto_postit.png){fig-alt="Een zware kluisdeur in een kantoor, en vooraan een rode post-it op het computerscherm."}
...
## Wat ligt hier te wachten? {.ai-beeld}

![](assets/crypto_quantum.png){fig-alt="Een archief vol verzegelde kluizen die geduldig worden opgeslagen, terwijl achter een glazen wand een vreemde machine gebouwd wordt."}
...
<small> - [uclftr.com](https://www.uclftr.com/post/what-does-the-rise-of-quantum-computers-mean-for-encryption-technology)</small>
:::
...
![Frequentie-analyse Nederlandstalige tekst (cijfers: Wikipedia).](crypto_assets/freqNL.png)
...
::: {.column width="45%"}
![Tabula recta](crypto_assets/vigenere.png){ width=70% }
:::
...
![](crypto_assets/skypre.png){ width=55% }
:::

::: {.column width="50%"}
Ciphertext na afwikkelen:

![](crypto_assets/skyna.png){ width=70% }
:::
...
## Wat maakt crypto "modern"? {.smaller}
...
::: {.column width="40%"}
![De 16 rondes die telkens 1 subkey maken.](crypto_assets/des6.png){ width=65% }
:::
...
## DES gekraakt in de praktijk {.smaller}
...
![](crypto_assets/ecb_mode.png){ width=90% fig-alt="ECB: elk blok wordt apart met dezelfde sleutel geëncrypteerd, twee gelijke plaintext-blokken geven twee gelijke ciphertext-blokken." }
...
![](crypto_assets/cbc_mode.png){ width=90% fig-alt="CBC: de IV of de ciphertext van het vorige blok wordt met de plaintext ge-XOR'd vóór de encryptie." }
...
::: {.column width="50%"}
![CTR mode: encryptie en decryptie.](crypto_assets/ctr.png){ width=100% }
:::
