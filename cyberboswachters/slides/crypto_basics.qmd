...
![](crypto_assets/kids1.png){ width=90% }

---

## Crypto volgens m'n kids, deel 2

![](crypto_assets/kids2.png){ width=90% }
...
3. **S-boxen**: 6 bits → 4 bits (substitutie)
4. **P-box**: permutatie

![Expansie van 32 naar 48 bits.](crypto_assets/des4.png){ width=90% }
...
## Block cipher modes: het probleem
...
* Goed IV-selectie algoritme is cruciaal
