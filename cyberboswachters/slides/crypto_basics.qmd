...
## Encryptie en decryptie (vervolg)
...
## Substitutie: Caesar encryptie (vervolg)
...
![De frequentie-analyse van een typisch Nederlandstalige tekst. Merk op dat de letterscore bij het bordspel Scrabble omgekeerd evenredig is met de frequentie dat de letter gemiddeld voorkomt. Dit verklaart ook waarom er per taal een eigen Scrabble-editie bestaat met eigen letterscores (Bron: Wikipedia).](crypto_assets/freqNL.jpg)
...
## Transpositie: scytale encryptie (vervolg)
...
![Tijd om de 300 in te roepen!](crypto_assets/skypre.png){ width=40% }
...
![Dit gaat Xerxes nooit kunnen lezen...Zeker niet omdat de Nederlandse taal toen nog niet bestond. Muhahahaha!](crypto_assets/skyna.png){ width=70% }
...
## Sleutellengtes en bruteforcen (vervolg)
...
## Een bruteforce getalvoorbeeld (vervolg)
...
## Soorten cryptanalytische aanvallen (vervolg)
...
## En wat met quantum-computers? (vervolg)
...
## Symmetrische encryptie (vervolg)

![Het basismodel van symmetrische encryptie.](crypto_assets/basicencrypt.png)
...
## Streamciphers (vervolg)

![Het streamcipher proces.](crypto_assets/stream.png)
...
## De keystream generator (vervolg)
...
![RC4 tot op het bot.](crypto_assets/rc4.png)
...
## KSA - Uitgewerkt voorbeeld (vervolg)
...
## Uitgewerkt voorbeeld van PRGA (vervolg)
...
![Een enkele Feistel-structuur.](crypto_assets/Feistelunit.png){ width=30% }

---

## Feistel-structuren (vervolg)
...
![DES encryptie. 16 Feistel-structuren na elkaar.](crypto_assets/des1.png){width=80%}
...
![De Initiële Permutatie.](crypto_assets/des2.png){ width=90% }
...
![Binnenin de F-operatie.](crypto_assets/des3.png){ width=60% }
...
![De expansie van 32 naar 48 bits.](crypto_assets/des4.png){ width=90% }
...
![De 16 rondes die telkens 1 subkey maken.](crypto_assets/des6.png){ width=60% }

---

## Subkeys maken (vervolg)
...
![Er zijn drie types P-Boxes, afhankelijk van wat ze met de data doen.](crypto_assets/pboxes.png){ width=100%}
...
![Het volgend voorbeeld toont een (overdreven) manier waarom ECB minder veilig is dan de modes die we nog gaan behandelen (Bron wikipedia).](crypto_assets/ecbfail.png){ width=75% }
...
![AES encryptie (Bron wikipedia).](crypto_assets/aes.png){ width=80% }
