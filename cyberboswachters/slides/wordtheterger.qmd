...
::: {.column width="50%"}
![Edward Snowden (2013). Bron: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Edward_Snowden-2.jpg), Laura Poitras / Praxis Films, CC BY 3.0.](assets/edward_snowden-2.jpg){ width=75% }
...
::: {.column width="30%"}
![Heartbleed-logo. Bron: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Heartbleed.svg), Leena Kurjenniska / Codenomicon, CC0.](assets/heartbleed.svg){ width=80% }

![Shellshock-logo. Bron: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Shellshock_logo_lock.svg), Bf5man, CC0.](assets/shellshock_logo_lock.svg){ width=80% }
:::
