...
::: {.column width="50%"}
![Normale communicatie tussen Step 7 en een Siemens PLC. Bron: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Step7_communicating_with_plc.svg), auteur Grixlkraxl, CC BY-SA 3.0.](assets/step7_communicating_with_plc.svg){ width=100% }
:::

::: {.column width="50%"}
![Stuxnet hijackt de communicatie door een eigen DLL (`s7otbxdx.dll`) tussen Step 7 en de PLC te plaatsen. Bron: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Stuxnet_modifying_plc.svg), auteur Grixlkraxl, CC BY-SA 3.0.](assets/stuxnet_modifying_plc.svg){ width=100% }
:::
...
* **20 mei 2026**: supply chain attack op **@antv** npm-pakketten (G2, G6 &mdash; in miljoenen dashboards)
* **640 kwaadaardige pakketten** offline, **61.274 npm-tokens** geïnvalideerd, **2.200+ repos** besmet
* Via dependency-keten ook in *echarts-for-react* (**>1 miljoen downloads/week**)

::: {.callout-warning .fragment}
**Payload (499 KB obfuscated JS)** draait alleen in **GitHub Actions** en steelt geheimen van GitHub, AWS, Vault, Kubernetes, 1Password en npm. Met gestolen npm-tokens publiceert hij zichzelf opnieuw &mdash; *als een worm*.
:::

::: {.callout-important .fragment}
Twee details die 2026 typeren:

* **SLSA-attestations geforgéérd** via Sigstore &rarr; lijkt legitiem voor supply-chain verificatietools
* Microsoft labelt de payload als `Trojan:AIGen/NPMStealer` &mdash; *AIGen* = *vermoedelijk door een LLM geschreven*
:::
