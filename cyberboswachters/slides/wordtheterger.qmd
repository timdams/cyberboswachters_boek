...
::: {.column width="50%"}
![Julian Assange (2008). Bron: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Julian_Assange_in_2008.jpg), auteur Periodismodepaz, CC BY 4.0.](assets/julian_assange_in_2008.jpg){ width=75% }
...
::: {.column width="50%"}
![Edward Snowden (2013). Bron: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Edward_Snowden-2.jpg), Laura Poitras / Praxis Films, CC BY 3.0.](assets/edward_snowden-2.jpg)
...
::: {.column width="45%"}
![Schema van een DDoS-botnet: aanvaller → *handlers* → *agents* (besmette IoT-apparaten) → slachtoffer. Bron: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Stachledraht_DDos_Attack.svg), Everaldo Coelho & YellowIcon, LGPL.](assets/stachledraht_ddos_attack.svg){ width=100% }
:::
