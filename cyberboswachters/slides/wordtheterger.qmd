...
format:
  revealjs:
    theme: [default, cyberboswachters.scss]
    lang: nl
    slide-number: true
    transition: slide
...
## {.ai-beeld background-image="assets/cover_wordtheterger.png" background-size="cover"}
...
timeline
    ...
    2026 : Mythos, AI-worms, autonome aanvalsketens - AI aan beide kanten
```
...
## Een wereld die draait op PLC's {.ai-beeld}

![](assets/plc_wereld.png){fig-alt="Een wereld vol kritieke installaties die allemaal verbonden zijn via PLC's."}
...
## Stuxnet:Normale werking PLC PLC {.smaller}
...
## Stuxnet: man-in-the-middle tussen Step 7 en PLC {.smaller}
...
::: {.column width="45%"}
![De uraniumverrijkingsinstallatie in Natanz (Iran), doelwit van Stuxnet. Bron: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Atomanlage_Natanz_(2022).jpg), auteur Parsa 2au, CC BY-SA 4.0.](assets/atomanlage_natanz_2022.jpg){ width=100% }
:::
...
## The veil is lifted {.ai-beeld}

::: {.curtain-stage}
![](assets/veil_lifted.png){fig-alt="Achter het gordijn luisteren duistere figuren ons af."}

```{=html}
<div class="curtain fragment"></div>
```
:::

---

## 2013: Privacy op het Internet is een illusie {.smaller}
...
::: {.column width="50%"}
![Julian Assange (2008). Bron: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Julian_Assange_in_2008.jpg), auteur Periodismodepaz, CC BY 4.0.](assets/julian_assange_in_2008.jpg){ width=55% }
...
::: {.column width="50%"}
![Edward Snowden (2013). Bron: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Edward_Snowden-2.jpg), Laura Poitras / Praxis Films, CC BY 3.0.](assets/edward_snowden-2.jpg){ width=55% }
...
![Originele gelekte NSA-slide: *"Dates When PRISM Collection Began For Each Provider"*. Van Microsoft (2007) tot Apple (2012). Bron: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Prism_slide_5.jpg), NSA, public domain.](assets/prism_slide_5.jpg){ width=60% fig-align="center" }
...
::: {.column width="40%"}
![](assets/verbergen_cover.png){ width=100% fig-alt="Cover van het boek Je hebt wél iets te verbergen." }
:::
...
## Data leeft langer dan jij denkt

![](assets/bevolkingsregister.jpg){fig-alt="Het Amsterdamse bevolkingsregister na de aanslag van 27 maart 1943."}

---

## Data leeft langer dan jij denkt {.smaller}

**Het Amsterdams bevolkingsregister** - een historische waarschuwing:

* Vóór WO II: Nederland had een buitengewoon nauwkeurig **bevolkingsregister** (adres, gezin, **godsdienst**) - te goeder trouw ingevuld voor gewone administratie.
* Onder nazi-bezetting werd net dát register hét instrument om Joodse burgers op te sporen en te deporteren.
* **27 maart 1943**: een verzetsgroep (o.l.v. **Van der Veen** & **Arondéus**) pleegt een aanslag op het register om de data te vernietigen → slechts ~15% verloren, **12 deelnemers gefusilleerd**.
...
## 2014: The Fappening - de cloud als doelwit {.smaller}
...
![](assets/interview.jpg){fig-alt="Filmposter van The Interview."}

---

## 2014: Als landen vechten - Sony & Noord-Korea {.smaller}
...
## Megaexploits {.ai-beeld}

![](assets/megaexploits.png){fig-alt="Eén kwetsbaarheid verspreidt zich als een lopend vuurtje over alle verbonden systemen."}
...
**2021 - Oldsmar, Florida**: hacker verhoogde natriumhydroxide in de waterfilters tot dodelijk niveau.

![](assets/oldsmar.png){ width=100% fig-alt="De aanval op Oldsmar botste op twee sensoren: de operator en de detectoren verderop." }
...
## Big data, big leaks {.ai-beeld}

![](assets/big_data.png){fig-alt="Steeds grotere hoeveelheden data lekken met steeds grotere gevolgen."}
...
::: {.column width="35%"}
![*"Life is short. Have an affair."* Bron: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Ashley_madison_logo.png), public domain.](assets/ashley_madison_logo.png){ width=100% }
:::
...
## No patch for human stupidity {.ai-beeld}
...
::: {.column width="55%"}
![](assets/social_engineering.png){ width=100% fig-alt="Een helpdesk-medewerker reset een wachtwoord voor een aanvaller, de firewall wordt gewoon omzeild." }
:::
...
## 2016: Internet-of-Horrors {.ai-beeld}

![](assets/iot_horrors.png){fig-alt="Huis en bewoner verbonden via allerlei IoT-apparaten, waarvan enkele besmet."}

---

## Shodan.io: een "Google voor IoT"

**[Shodan.io](https://www.shodan.io/)** brengt alle publiek zichtbare IoT-apparaten in kaart - inclusief welke nog het standaard wachtwoord hebben.
...
## 2016: Internet-of-Horrors - Mirai botnet {.smaller}
...
::: {.column width="45%"}
![Schema van een DDoS-botnet: aanvaller → *handlers* → *agents* (besmette IoT-apparaten) → slachtoffer. Bron: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Stachledraht_DDos_Attack.svg), Everaldo Coelho & YellowIcon, LGPL.](assets/stachledraht_ddos_attack.svg){ width=70% }
:::
...
## 2017: losgeld gevraagd! {.ai-beeld}

![](assets/ransomware.png){fig-alt="Ransomware legt ziekenhuizen en bedrijven plat en eist losgeld."}
...
## Demant: het losgeld is maar het topje

:::: {.columns}

::: {.column width="45%"}
::: {.callout-warning}
**Demant (2019, Denemarken)**: ransomware-incident bij hoortoestelfabrikant → **$95 miljoen** totale kost, zelfs zonder losgeld te betalen.

Ransomware-schade is zelden enkel het losgeld - indirecte kosten domineren.
:::
:::

::: {.column width="55%"}
![](assets/demant.png){ width=100% fig-alt="IJsberg: het losgeld is het topje, de indirecte kosten van 95 miljoen dollar zitten eronder." }
:::
...
## 2017: WannaCry en de NSA {.smaller}
...
* **[NSA ANT Product Catalog](https://www.cryptomuseum.com/covert/bugs/nsaant/files/NSA_ANT_20070108.pdf)** (2013, Der Spiegel): complete "catalogus" met NSA-spionage-gadgets - bv. **PICASSO**, een gemodde GSM die gesprekken, locatie en kamer-audio afluistert + een "panic button" voor de gebruiker bevat.
...
::: {.fragment}
![](assets/backups.png){ width=85% fig-align="center" fig-alt="Eén back-up naast je servers is niet genoeg: meerdere back-ups, niet alles on-prem, en eentje offline." }
:::

---

## 2018: Haven Antwerpen - cybercrime meets maffia {.smaller}
...
## 2019: De eerste kinetische respons {.smaller}
...
## 2020: Sociale media als geopolitiek wapen {.smaller}
...
::: {.column width="30%"}
![Log4J-logo. Bron: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Apache_Log4j_Logo.svg), Apache Software Foundation, CC0 / Apache 2.0.](assets/apache_log4j_logo.svg){ width=100% }
:::
...
## 2023: Scattered Spider - MGM Resorts {.ai-beeld}
...
::: {.column width="60%"}
![](assets/scattered_spider.png){ width=100% fig-alt="Via één telefoontje naar de helpdesk legt Scattered Spider een casinoresort plat." }
:::
...
::: {.column width="50%"}
![](iot_assets/supchain.png){ width=100% fig-alt="Supply chain attack: de aanvaller richt zich op een zwakke schakel in de keten." }
:::
...
## 2026: A.I. hell {.ai-beeld}

![](assets/ai_hell.png){fig-alt="Een brandende wereld, geterroriseerd door AI-gedreven aanvallen."}
...
[Bron](https://www.aisi.gov.uk/blog/our-evaluation-of-openais-gpt-5-5-cyber-capabilities)

---

## Mei 2026: Mini Shai-Hulud - AI-gegenereerde worm in npm

* **Mei 2026**: gecompromitteerd maintainer-account &rarr; vergiftigde **\@antv** npm-pakketten (G2, G6); via *echarts-for-react* >1 miljoen downloads/week besmet
* Payload draait enkel in **GitHub Actions**, steelt CI/CD-secrets (GitHub, AWS, Vault, K8s, npm) en publiceert zichzelf opnieuw met gestolen tokens - *als een worm* (Dune-knipoog)
* Microsoft labelt de payload als `Trojan:AIGen/NPMStealer` - *vermoedelijk LLM-geschreven code*

::: {.callout-important .fragment}
Bilan: **640 pakketten offline**, **61.274 npm-tokens** geïnvalideerd, **2.200+ besmette repos**.
:::
...
* **Juni 2026**: het Witte Huis verbiedt Anthropics nieuwste modellen (**Fable 5**, **Mythos 5**) voor iedereen **zonder Amerikaanse nationaliteit** - wereldwijd
* Filtering op nationaliteit is technisch onhaalbaar → beide modellen voor **álle** klanten uitgeschakeld (oudere Claude-modellen blijven werken)
* Aanleiding: een vermoede **jailbreak** waarmee Fable 5 kwetsbaarheden zou opsporen

::: {.callout-note .fragment}
Anthropic weerspreekt: het ging om enkele *reeds bekende*, triviale bugs die **GPT-5.5** óók vindt - zónder omzeiling. Net wat security-experts dagelijks legitiem doen.
:::
...
* Waterdichte beveiliging tegen jailbreaks is industriebreed **onmogelijk**
* Daarom **defense in depth**: monitoring + 30 dagen dataretentie
* Fable 5 vooraf duizenden uren getest (VS-overheid, **AISI**, externen)
:::

::: {.column width="45%"}
::: {.callout-warning}
Een commercieel model voor honderden miljoenen gebruikers terugtrekken om **één beperkte bug**?

Wordt dit de norm, dan valt de uitrol van álle toekomstige AI-modellen stil.
:::
:::
...
## Sept 2026: van hypothese naar praktijk

**Anthropic threat report** (dec 2025 – aug 2026): staatsactoren én criminelen betrapt op échte aanvalscampagnes met AI

::: {.incremental}
* **Rusland** (*Midnight Blizzard*): 20+ Oekraïense/Europese overheidsdoelwitten - volledige keten **autonoom**, malware herschreef zichzelf tot de scanner zweeg
* **China**: twee **bachelorstudenten** met *agent swarms* → 12+ mogelijke zerodays in één maand, ~50 organisaties
* **ShinyHunters**: 1,8 miljoen Android-apps afgespeurd op secrets; >1 TB data, tientallen miljoenen passagiersgegevens; **uren** van inbraak tot massale diefstal
* **Desinformatie**: ~70 nepnieuwssites, 8.913 artikels in 20 talen; 1.000+ nep-X-accounts voor 222 Maleisische kieskringen
:::

---

## Sept 2026: wat leren we eruit?

:::: {.columns}

::: {.column width="55%"}
::: {.callout-important}
**Attack sophistication ↑, vereiste kennis ↓**

Anthropic: AI dichtte de kloof in *mankracht en gereedschap*. De twee studenten uit Hunan: 12+ mogelijke zerodays op één maand.
:::

::: {.fragment}
Zodra de keten autonoom draait, kost een extra doelwit bijna niets: **ook kleine organisaties zijn rendabele doelwitten**.
:::
:::

::: {.column width="45%"}
::: {.callout-note}
**Ook buit: AI-toegang zelf**

Gestolen API-keys, sessietokens en accounts worden doorverkocht.
:::

::: {.callout-tip .fragment}
**Lichtpuntje**: we wéten dit omdat het een *cloud*-model was - de aanbieder kijkt mee, sluit accounts af en deelt de indicatoren. Bij lokale open modellen ziet niemand iets.
:::
:::
...
![](assets/aiverdediger.png){ width=100% fig-alt="AI herkent dat een laptop om 3u 's nachts gigabytes naar een onbekend IP stuurt en isoleert het systeem." }
...
* **Sept 2026** - van hypothese naar praktijk: autonome AI-aanvalsketens in het wild
...
**Sinds februari 2023: ethisch hacken is legaal in België!**
...
* **[Darknet Diaries](https://darknetdiaries.com/)**: podcast met waargebeurde "horror-verhalen" over het darknet
* **Microsoft Digital Defense Report**: jaarlijkse state-of-the-state
* **Tools**: uBlock Origin, AdGuard, Privacy Badger (Firefox ook op Android), Pihole/Adguard/Quad9
:::
