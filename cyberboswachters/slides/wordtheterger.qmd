...
* Payload draait enkel in **GitHub Actions**, steelt CI/CD-secrets (GitHub, AWS, Vault, K8s, npm) en publiceert zichzelf opnieuw met gestolen tokens &mdash; *als een worm* (Dune-knipoog)
* Microsoft labelt de payload als `Trojan:AIGen/NPMStealer` &mdash; *vermoedelijk LLM-geschreven code*
