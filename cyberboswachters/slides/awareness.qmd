...
In hoofdstuk 2 bespraken we reeds de McCumber cube. Deze visualisatie helpt ons om in te zien dat we cybersecurity vanuit al z'n dimensies en facetten moeten bekijken. Hierbij waren de voorbije hoofdstukken vooral gericht op het technologie-aspect in functie van C.I.A en de staat van de data (processing, storage, transmission).

---

## Bescherm de hele keten: McCumber Cube (vervolg)
...
## Gebruikersverwarring voorkomen (vervolg)
...
## Succesvolle awareness-methoden (vervolg)
...
## Praktische best practices (vervolg)
...
## Social engineering en phishing (vervolg)
