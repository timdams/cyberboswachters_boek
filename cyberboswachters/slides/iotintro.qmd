...
![Versie 2018 (Bron owasp.org).](iot_assets/top10.jpg)
...
## Ongebruikte of onveilige netwerkservices (vervolg)
...
![Bron afbeelding en artikel: https://www.inktweb.nl/blog/hacker-neemt-150-000-printers-over/](iot_assets/printer.jpg){width=60%}
:::
...
## Geen of onveilig updatemechanisme (vervolg)
...
![BrakTooth: de zoveelste Bluetooth kwetsbaarheid.](iot_assets/brak.jpg){width=30%}
:::
...
## Oude of onveilige componenten (vervolg)
...
![Bron dynatrace.com](iot_assets/supchain.png){width=75%}
:::
...
## Onveilige datatransfer en opslag (vervolg)
...
## Gebrek aan apparaat management (vervolg)
...
## Onveilige standaard instellingen (vervolg)
...
## Gebrek aan fysieke *hardening* (vervolg)
