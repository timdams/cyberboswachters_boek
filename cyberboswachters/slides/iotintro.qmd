...
## {.ai-beeld background-image="assets/cover_iot.png" background-size="cover"}
...
## #1 - Zwakke of hardcoded wachtwoorden {.smaller}
...
## #4 - Geen of onveilig updatemechanisme {.smaller}
...
![Supply chain attack: de aanvaller richt zich op een zwakke schakel in de keten.](iot_assets/supchain.png){ width=75% }
...
## #8 - Gebrek aan apparaatbeheer {.smaller}
...
## #9 - Onveilige standaardinstellingen {.smaller}
...
## #10 - Gebrek aan fysieke hardening {.smaller}
