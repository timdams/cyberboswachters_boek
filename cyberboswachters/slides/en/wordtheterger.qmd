...
## Stuxnet: normal operation of a PLC {.smaller}
...
## 2013: Privacy on the Internet is an illusion {.smaller}
...
::: {.column width="50%"}
![Julian Assange (2008). Source: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Julian_Assange_in_2008.jpg), author Periodismodepaz, CC BY 4.0.](../assets/julian_assange_in_2008.jpg){ width=55% }
...
::: {.column width="50%"}
![Edward Snowden (2013). Source: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Edward_Snowden-2.jpg), Laura Poitras / Praxis Films, CC BY 3.0.](../assets/edward_snowden-2.jpg){ width=55% }
...
## 2013: "I have nothing to hide anyway" {.smaller}
...
## 2014: The Fappening - the cloud as a target {.smaller}
...
## 2014: When countries fight - Sony & North Korea {.smaller}
:::: {.columns}
...
## 2015: Ukraine - power down {.smaller}
...
## 2015: Ashley Madison - data as a weapon {.smaller}
...
## 2016: Social engineering against the CIA {.smaller}
...
## Shodan.io: a "Google for IoT"

**[Shodan.io](https://www.shodan.io/)** maps all publicly visible IoT devices - including the ones still using default passwords.
...
::: {.column width="45%"}
![Diagram of a DDoS botnet: attacker → *handlers* → *agents* (infected IoT devices) → victim. Source: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Stachledraht_DDos_Attack.svg), Everaldo Coelho & YellowIcon, LGPL.](../assets/stachledraht_ddos_attack.svg){ width=60% }
:::
...
## 2017: WannaCry & Petya - ransomware on a global scale {.smaller}
...
## 2017: WannaCry and the NSA {.smaller}
...
## 2017: LockBit chat logs (2025) {.smaller}
...
## 2019: The first kinetic response {.smaller}
...
## 2020: Social media as a geopolitical weapon {.smaller}
...
## Log4J: the JNDI injection {.smaller}
...
## 2022-2024: MFA Fatigue - the human as the weakest link {.smaller}
...
## 2024: CrowdStrike - one update, worldwide chaos {.smaller}
...
## Become an ethical hacker! {.smaller}
